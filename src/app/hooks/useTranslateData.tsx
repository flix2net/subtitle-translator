...
const useTranslateData = () => {
  ...
  const retryTranslate = async (text: string, cacheSuffix: string, config: TranslationRuntimeConfig, fullText?: string) => {
    ...
    const translateParams: TranslateTextParams = {
      ...
      ...(config.translationMethod === "nvidia" && config.useRelay !== undefined ? { useRelay: config.useRelay } : {}),
      ...(config.translationMethod === "mistral" && config.useRelay !== undefined ? { useRelay: config.useRelay } : {}),
      ...(config.translationMethod === "cohere" && config.useRelay !== undefined ? { useRelay: config.useRelay } : {}),
      ...(config.translationMethod === "xai" && config.useRelay !== undefined ? { useRelay: config.useRelay } : {}),
